...
public class BlazorCanvasInterop
{
    ...
    {
        _jsUnmarshalledRuntime.InvokeUnmarshalled<string, float[], object>("wrapText", text,
            new[] { x, y, maxWidth, maxHeight, lineHeight });
    }
    ...
    {
        _jsUnmarshalledRuntime.InvokeUnmarshalled<string, float[], object>("drawImage", src,
    ...
    {
        _jsUnmarshalledRuntime.InvokeUnmarshalled<string, float[], object>("drawCanvas", canvasName,
            new[] { x, y, width, height });
    }
